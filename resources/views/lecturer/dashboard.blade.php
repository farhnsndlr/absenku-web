...
@section('navigation')
    ...
    <a href="{{ route('lecturer.dashboard') }}"
       class="flex items-center gap-3 px-4 py-3 rounded-lg transition font-medium {{ request()->routeIs('lecturer.dashboard') ? 'text-blue-600 bg-blue-50' : 'text-gray-700 hover:bg-gray-100' }}">
    ...
    <a href="{{ route('lecturer.sessions.index') }}"
       class="flex items-center gap-3 px-4 py-3 rounded-lg transition font-medium {{ request()->routeIs('lecturer.sessions.*') ? 'text-blue-600 bg-blue-50' : 'text-gray-700 hover:bg-gray-100' }}">
    ...
    <a href="{{ route('lecturer.reports.index') }}"
       class="flex items-center gap-3 px-4 py-3 rounded-lg transition font-medium {{ request()->routeIs('lecturer.reports.*') ? 'text-blue-600 bg-blue-50' : 'text-gray-700 hover:bg-gray-100' }}">
       <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
